...
namespace it_service_app.Services
{
    public class EmailSender : IEmailSender
    {
        ...
        public int SmtpPort =>Convert.ToInt32(_configuration.GetSection("EmailOptions:SmtpPort").Value);
         // SimpleMailTransferProtocolPort property
        ...
        public async Task SendAsync(EmailMessage message)
        {
            ...
            if (message.Cc!=null && message.Cc.Length>0)  //  for Cc ==>> recipient
            {
            ...
            if (message.Bcc!=null && message.Bcc.Length>0) //  specifies blindes carbon copy=>>
            {
